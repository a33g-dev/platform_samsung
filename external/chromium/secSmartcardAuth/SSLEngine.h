...
/** @file SSLEngine.h 
 *  @brief SSL helper utility Native Interface
 */
...
#ifdef SEC_PRODUCT_FEATURE_SECURITY_SUPPORT_TIMA
    ENGINE* registerSSLEngineUsingCCM(char* alias, unsigned int alias_len);
#endif
